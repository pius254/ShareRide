                            ...
                            <div class="col-sm-4 col-xs-12">
                                <div class="single_widget wow fadeIn" data-wow-duration="800ms">
                                    <div class="footer_logo">
                                        <img src="{{ asset('images/default2.jpg') }}" alt="" />
                                    </div>
                                    <p>ShareRide - Your dream come true, reliable and affordable.</p>
                                </div>
                            </div>
                                ...
                                <div class="single_widget wow fadeIn" data-wow-duration="800ms">
                                    ...
                                    <ul>
                                        <li><a href="">
                                                ...
                                                <span>iSpace Office Suites <br />
                                                iRoad.<br />
                                                iWorld, iCity.</span>
                                            </a></li>
                                        <li><a href=""><i class="fa fa-phone"></i> +254 721 886 636</a></li>
                                    </ul> 
                                </div>
                            </div>
